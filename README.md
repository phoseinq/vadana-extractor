...
سلام 👋 به ربات آرشیو کلاس‌های وادانا خوش آمدید.

**روش دریافت لینک:** وارد آرشیو وادانا شوید، روی کلاس موردنظر بزنید، لینکِ بالای مرورگر را کامل کپی کنید و همین‌جا بفرستید.

**یک گزینه را انتخاب کنید، بعد لینک را بفرستید:**
📄 فایل‌ها (اسلایدهای PDF) · 📝 وایت‌برد (نوشته‌های استاد، PDF) · 🎬 ویدیوی آرشیو (وایت‌برد/اسلاید + صدا)
